...
if ($_FILES["portada"]["error"] <= 0) {
    ...
    $salida = $server->verificarArchivo($_FILES["portada"]);
} else {
...
right: .8em; font-size: 1.2em; font-family: arial; color: grey; " href="../index.php">X</a>
        <div style="color:green; margin-left: 1em; font-size: 1.2em; font-family: arial; ;" class="datos">
            <img style="position:absolute;  top: 4em;
                right: 3em; width: 30%; heigth: 30px" src="archivos/<?php echo $_FILES["portada"]["name"]?>" alt="<?php echo $_FILES["portada"]["tmp_name"]?>" />
